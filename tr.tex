...
\begin{center}
    ...
    \small İstanbul-Sakarya $|$ Askerlik: Yapıldı
\end{center}
...
\section{Projeler ve Açık Kaynak}
    \resumeSubHeadingListStart
      \resumeProjectHeading
          ...
          \resumeItemListStart
            \resumeItem{Modern React için üretime hazır iskelet oluşturma CLI'si. Next.js ve TanStack Start şablonlarını arayüzden kur.}
          \resumeItemListEnd
          
      \resumeProjectHeading
          {\textbf{ViraStack AI} $|$ \href{https://github.com/virastack/ai}{\underline{github.com/virastack/ai}}}{2026}
          \resumeItemListStart
            \resumeItem{Modern React için AI-native mimari kiti. Disiplinli agent kuralları tek komutla.}
          \resumeItemListEnd

      \resumeProjectHeading
          {\textbf{ViraStack Mask} $|$ \href{https://github.com/virastack/mask}{\underline{github.com/virastack/mask}}}{2025}
          \resumeItemListStart
            \resumeItem{React'te input formatlama ve durum senkronizasyonu için hafif standart.}
          \resumeItemListEnd

      \resumeProjectHeading
          {\textbf{ViraStack Password} $|$ \href{https://github.com/virastack/password}{\underline{github.com/virastack/password}}}{2025}
          \resumeItemListStart
            \resumeItem{React için tam erişilebilir ve özelleştirilebilir şifre görünürlük hook'u.}
          \resumeItemListEnd

      \resumeProjectHeading
          {\textbf{ViraStack Guide} $|$ \href{https://github.com/virastack/guide}{\underline{github.com/virastack/guide}}}{2025}
          \resumeItemListStart
            \resumeItem{Modern web uygulamalarının nasıl inşa edildiğini gösteren etkileşimli, adım adım bir yolculuk.}
          \resumeItemListEnd
          
      \resumeProjectHeading
          {\textbf{Footy} $|$ \href{https://footy.omergulcicek.com/}{\underline{footy.omergulcicek.com/}}}{2025}
          \resumeItemListStart
            \resumeItem{Futbol bilgini sına: Bil Bakalım, Skor Avcısı, Kupon Ustası ve Kadro Bulmacası.}
          \resumeItemListEnd
          
      \resumeProjectHeading
          {\textbf{Takvim} $|$ \href{https://takvim.omergulcicek.com}{\underline{takvim.omergulcicek.com}}}{2025}
          \resumeItemListStart
            \resumeItem{Takvim abonelikleri için ücretsiz, açık kaynak arayüzler ve içerik.}
          \resumeItemListEnd
